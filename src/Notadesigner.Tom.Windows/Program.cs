            ...
            try
            {
                ...
                var builder = Host.CreateDefaultBuilder(args)
                    ...
                    .ConfigureServices((_, services) =>
                    {
                        ...
                        var settingsFactory = () => new PomoEngineSettings(appSettings.MaximumRounds, appSettings.PomodoroDuration, appSettings.ShortBreakDuration, appSettings.LongBreakDuration, appSettings.LenientMode);
