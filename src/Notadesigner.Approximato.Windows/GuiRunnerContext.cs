...
namespace Notadesigner.Approximato.Windows
{
    public class GuiRunnerContext : ApplicationContext, INotifyPropertyChanged
    {
        ...
        {
            var result = MessageBox.Show("Abandon the Pomodoro?", "Approximato", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void ExitMenuClickHandler(object? sender, EventArgs e)
        {
            ...
            {
                result = MessageBox.Show("Halt Pomodoro and exit?", "Approximato", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            }
